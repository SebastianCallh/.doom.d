...
(setq doom-font (font-spec :family "<<font("code")>>" :size 16)
      doom-variable-pitch-font (font-spec :family "<<font("prose")>>")
      doom-unicode-font (font-spec :family "<<font("code")>>")
      doom-big-font (font-spec :family "<<font("code")>>" :size 28))
#+end_src
